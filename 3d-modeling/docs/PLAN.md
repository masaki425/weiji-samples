...
|S12|エデンの海、錯視から解放された魚|管理棟・洋室の奥側|S09と同じ合板壁の端に彩色の試作プリントを暫定掲示。薄い白紙、下にキャプション札|0.594×0.002×0.526（紙は0.594×0.420）|`D/PXL_20251118_053103762.jpg`<br>`N/6Q9A6479aa.jpg`<br>`N/6Q9A6516aa.jpg`|未確認／配置（暫定位置）。U14。実際の掲出場所・寸法は制作者確認待ち。写真提供：渡辺英治／錯視画像：北岡明佳|
